...
In facturacion_prac-labels_en.properties:
facturacion_prac=My application
facturacion_prac[description]=My application does this and that

In facturacion_prac-messages_en.properties:
