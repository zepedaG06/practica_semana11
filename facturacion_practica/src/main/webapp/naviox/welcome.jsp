...
In facturacion_practica-labels_en.properties:
facturacion_practica=My application
facturacion_practica[description]=My application does this and that

In facturacion_practica-messages_en.properties:
